...
export const PHRASES={
  ...
  'Apartats del Centre de Dades':{es:'Apartados del Centro de Datos',en:'Data Centre sections'},
  'Resum':{es:'Resumen',en:'Summary'},
  'Gràfiques':{es:'Gráficas',en:'Charts'},
  'Pluja':{es:'Lluvia',en:'Rain'},
  'Episodis':{es:'Episodios',en:'Events'},
  'Qualitat':{es:'Calidad',en:'Quality'},
  'Comprovant la cobertura anual…':{es:'Comprobando la cobertura anual…',en:'Checking annual coverage…'},
  'Rècords de l’Observatori':{es:'Récords del Observatorio',en:'Observatory records'},
  'Màximes i mínimes de tot l’arxiu disponible, amb data i hora.':{es:'Máximos y mínimos de todo el archivo disponible, con fecha y hora.',en:'Highs and lows from the complete available archive, with date and time.'},
  'Veure rècords històrics →':{es:'Ver récords históricos →',en:'View historical records →'},
  'Tot l’arxiu disponible':{es:'Todo el archivo disponible',en:'Complete available archive'},
  'Rècords principals de l’Observatori':{es:'Récords principales del Observatorio',en:'Main Observatory records'},
  'Veure la taula completa →':{es:'Ver la tabla completa →',en:'View full table →'},
  'Preparant els rècords històrics…':{es:'Preparando los récords históricos…',en:'Preparing historical records…'},
  'Els extrems de tot l’arxiu disponible.':{es:'Los extremos de todo el archivo disponible.',en:'Extremes from the complete available archive.'},
  'Valor i moment del primer registre de cada extrem.':{es:'Valor y momento del primer registro de cada extremo.',en:'Value and time of the first occurrence of each extreme.'},
  'Comprovant des de quan hi ha dades disponibles…':{es:'Comprobando desde cuándo hay datos disponibles…',en:'Checking available archive coverage…'},
  ...
  'Tendència de llarg termini':{es:'Tendencia a largo plazo',en:'Long-range trend'},
  'Com poden ser les pròximes sis setmanes?':{es:'¿Cómo pueden ser las próximas seis semanas?',en:'What could the next six weeks look like?'},
  'Mitjanes setmanals i diferència respecte de la climatologia del mateix model. No són pronòstics dia a dia.':{es:'Medias semanales y diferencia respecto a la climatología del mismo modelo. No son pronósticos día a día.',en:'Weekly means and differences from the same model’s climatology. These are not day-by-day forecasts.'},
  'Preparant ECMWF EC46…':{es:'Preparando ECMWF EC46…',en:'Preparing ECMWF EC46…'},
  'Calculant la tendència setmanal…':{es:'Calculando la tendencia semanal…',en:'Calculating the weekly trend…'},
  'Predicció mensual oficial ↗':{es:'Predicción mensual oficial ↗',en:'Official monthly forecast ↗'},
  'Mapes d’anomalies de temperatura i precipitació':{es:'Mapas de anomalías de temperatura y precipitación',en:'Temperature and precipitation anomaly maps'},
  'Com funciona l’horitzó subestacional ↗':{es:'Cómo funciona el horizonte subestacional ↗',en:'How the sub-seasonal range works ↗'},
  'Metodologia i límits fins a 46 dies':{es:'Metodología y límites hasta 46 días',en:'Methodology and limits up to 46 days'},
  'Dades':{es:'Datos',en:'Data'},
  'Mitjana del conjunt i anomalies setmanals':{es:'Media del conjunto y anomalías semanales',en:'Ensemble mean and weekly anomalies'},
  'A partir de la segona setmana la incertesa augmenta molt. Aquesta vista serveix per detectar una tendència més càlida, freda, seca o humida; cal tornar a la previsió de 7 dies abans de prendre decisions.':{es:'A partir de la segunda semana la incertidumbre aumenta mucho. Esta vista sirve para detectar una tendencia más cálida, fría, seca o húmeda; conviene volver a la previsión de 7 días antes de tomar decisiones.',en:'Uncertainty increases substantially from the second week. This view can indicate a warmer, colder, drier or wetter trend; return to the 7-day forecast before making decisions.'},
  'Font: Servei Meteorològic de Catalunya · ECMWF SEAS5':{es:'Fuente: Servei Meteorològic de Catalunya · ECMWF SEAS5',en:'Source: Meteorological Service of Catalonia · ECMWF SEAS5'},
  'Veure la predicció mensual oficial ↗':{es:'Ver la predicción mensual oficial ↗',en:'View the official monthly forecast ↗'},
  'És una tendència probabilística mensual, no una predicció concreta per a cada dia ni un avís oficial. La precipitació té més incertesa a la Mediterrània.':{es:'Es una tendencia probabilística mensual, no una predicción concreta para cada día ni un aviso oficial. La precipitación tiene más incertidumbre en el Mediterráneo.',en:'This is a probabilistic monthly trend, not a specific daily forecast or an official alert. Precipitation is more uncertain in the Mediterranean.'},
  'Setmana':{es:'Semana',en:'Week'},
  'Temperatura mitjana del model':{es:'Temperatura media del modelo',en:'Model mean temperature'},
  'Sense senyal':{es:'Sin señal',en:'No signal'},
  'Molt més càlida':{es:'Mucho más cálida',en:'Much warmer'},
  'Més càlida':{es:'Más cálida',en:'Warmer'},
  'Molt més freda':{es:'Mucho más fría',en:'Much colder'},
  'Més freda':{es:'Más fría',en:'Colder'},
  'Prop de la normal':{es:'Cerca de lo normal',en:'Near normal'},
  'Més humida':{es:'Más húmeda',en:'Wetter'},
  'Més seca':{es:'Más seca',en:'Drier'},
  'Sense senyal clar':{es:'Sin señal clara',en:'No clear signal'},
  'Anomalia no disponible':{es:'Anomalía no disponible',en:'Anomaly unavailable'},
  'mitjana':{es:'media',en:'mean'},
  'ECMWF EC46 · actualització diària':{es:'ECMWF EC46 · actualización diaria',en:'ECMWF EC46 · daily update'},
  'La tendència automàtica no està disponible ara mateix.':{es:'La tendencia automática no está disponible ahora mismo.',en:'The automated trend is currently unavailable.'},
  'Pots consultar la predicció mensual oficial d’AEMET amb els botons de sota.':{es:'Puedes consultar la predicción mensual oficial de AEMET con los botones inferiores.',en:'You can view AEMET’s official monthly forecast using the buttons below.'},
  'Consulta oficial disponible':{es:'Consulta oficial disponible',en:'Official source available'},
