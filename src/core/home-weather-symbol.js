...
export function weatherSymbol(code,light='unknown'){
  ...
  // Mixed/unknown daylight uses a neutral sky motif. The moon is not its real phase.
  const sky=light==='night'?moon:light==='day'?sun:'<circle cx="29" cy="26" r="15" fill="none" stroke="#b8d9cb"/><path d="M9 47h40m-34 7h28" stroke="#b8d9cb"/>';
  ...
  return `<svg viewBox="0 0 64 68" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${body}</svg>`;
}
