...
const NETWORKS=[['instagram','Instagram'],['facebook','Facebook'],['threads','Threads'],['bluesky','Bluesky'],['telegram','Telegram'],['tiktok','TikTok'],['whatsapp','WhatsApp'],['youtube','YouTube']];
