...
function render(payload){
  ...
  hero.innerHTML=`<div class="verification-orbit is-ready" aria-label="${days} dies verificats"><strong>${days}</strong><span>dies verificats</span></div><div><h4>Resultats mesurats, no impressions</h4><p>Com més baixa és la diferència en graus i km/h, millor. Amb aquesta mostra, el model ${biasCopy}. L’encert de pluja indica en quants dies va anticipar correctament si plouria.</p></div>`;
