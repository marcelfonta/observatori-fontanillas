...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-31-3-frances-colaboracions'));
...
console.log('Test V22.31.3: traducció dinàmica i capçalera mòbil compacta');
