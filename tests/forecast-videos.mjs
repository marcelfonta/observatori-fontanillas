...
assert.match(page,/<a data-video-source="3cat"[^>]+target="_blank"[^>]+hidden/);
...
assert.match(feature,/youtube-nocookie\.com\/embed\/videoseries\?list=UUd-ceYPisAtCmmoZa26I-5g/);
assert.match(feature,/link\.href=sources\['3cat'\]\.sourceUrl/);
assert.match(feature,/control\.tagName==='A'/);
