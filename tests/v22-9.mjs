...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-30-1-traduccio-mobil')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
