...
assert.equal(JSON.parse(project).version,'22.31.1');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-31-1-frances-colaboracions')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
