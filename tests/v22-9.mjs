...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-23-1')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
