...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-22-0')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
