...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-31-3-frances-colaboracions')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
