...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-24-0-xarxes')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
