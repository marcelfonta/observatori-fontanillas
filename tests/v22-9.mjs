...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-29-1-xarxes')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
