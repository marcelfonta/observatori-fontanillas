...
assert.equal(JSON.parse(project).version,'22.22.2');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-22-2')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
