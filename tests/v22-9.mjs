...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-31-0-frances-colaboracions')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
