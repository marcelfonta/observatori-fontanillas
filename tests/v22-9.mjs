...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-31-7-morning-publication-0645')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
