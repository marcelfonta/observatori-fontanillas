...
assert.equal(JSON.parse(project).version,'22.25.1');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-25-1-xarxes')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
