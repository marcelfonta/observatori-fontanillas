...
assert.ok(portal.includes("['municipis','Qualsevol lloc','./municipis.html']")&&portal.includes("['Ara',['inici','meteo-ia','estacio','municipis']")&&portal.includes("['municipis','Llocs']"));
