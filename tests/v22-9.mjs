...
assert.equal(JSON.parse(project).version,'22.12.0');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-12-0')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
