...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-13-0')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
