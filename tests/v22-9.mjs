...
assert.equal(JSON.parse(project).version,'22.27.0');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-27-0-xarxes')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
