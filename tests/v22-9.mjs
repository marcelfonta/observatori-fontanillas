...
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-28-1-xarxes')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
