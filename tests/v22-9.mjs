...
assert.equal(JSON.parse(project).version,'22.23.0');
assert.ok(serviceWorker.includes('observatori-fontanillas-v22-23-0')&&serviceWorker.includes("'/municipis.html'")&&serviceWorker.includes("'/src/features/municipality-explorer.js'"));
