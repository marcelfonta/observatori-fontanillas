...
assert.equal(project.version, '22.12.0');
assert.match(worker, /WORKER_VERSION = "22\.12\.0"/);
...
console.log('Test V22.12.0: fiabilitat de publicacions, push i manteniment D1');
