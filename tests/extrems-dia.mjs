...
assert.match(oneSignalWorkerSource, /service-worker\.js\?v=records-v1/, 'El Worker compartit de OneSignal ha de detectar i instal·lar la nova versió de la PWA.');
