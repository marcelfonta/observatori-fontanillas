 ...
 *{box-sizing:border-box}body{margin:0;width:1080px;height:1350px;padding:68px 72px;color:#edf4eb;font-family:Arial,sans-serif;background:radial-gradient(ellipse at 76% 35%,#315c48,transparent 75%),#071a16;position:relative;overflow:hidden}
 ...
 ${!midday?'.date{margin-top:32px}h1{margin:20px 0}.stamp{margin-bottom:24px}article{height:143px;padding-top:14px}article strong{margin-top:10px}.values{margin-top:8px}':''}
 ...
 <div class="date">${evening?'DEMÀ':'AVUI'} · ${esc(date)} · hora de Sant Celoni</div><h1>${midday?'Ara, i el que queda del dia.':evening?'Ara i la previsió de demà.':'El dia, franja a franja.'}</h1>
