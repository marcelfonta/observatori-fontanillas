...
const selected = quick
  ? all.filter(name => ['smoke.mjs', 'admin.mjs', 'forecast-videos.mjs', 'meteocat-severe-alerts.mjs', 'social-periodic.mjs', 'social-publication-quality.mjs', 'youtube-short.mjs', 'v22-2.mjs', 'v22-12.mjs'].includes(name))
  : all;
