...
1. Llegeix `PROJECT.md`, `docs/AI-WORKFLOW.md`, `docs/DECISIONS.md` i la part rellevant de `ROADMAP.md`.
...
- `npm run check` superat abans del PR. Quan existeixi una configuració Wrangler real i revisada, afegeix també `npm run worker:dry-run`.
