OBSERVATORI FONTANILLAS · PUBLICAR LA VERSIÓ 4.1
...
git add .
git commit -m "Millora dades, prediccio, models i radar"
...
No cal modificar el Worker ni les claus secretes per publicar aquesta versió.
